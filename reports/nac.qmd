...
# Every panel below is cropped to this same view, regardless of its native grid
# resolution (1° climatology, 1/12° truth/velocity) -- so tabs line up exactly.
...
# GLORYS truth, monthly-mean, on the same analysis-region native grid used for the anomaly.
...
# GLORYS eastward/northward velocity near the 1000 m parking depth, monthly-mean,
# restricted to the analysis region (same box as the truth/anomaly cells above).
